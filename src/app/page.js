  ...
  return (
    <div className="bg-gray-100 text-gray-800">
      ...
      <section className="py-20 bg-white px-5 flex flex-col items-center">
        ...
        <Link className="bg-green-700 hover:bg-green-800 text-white font-bold mt-6 px-6 py-2 rounded-lg" href="https://expo.dev/preview/update?message=corrections&updateRuntimeVersion=1.0.0&createdAt=2024-11-29T18%3A38%3A32.870Z&slug=exp&projectId=029f935d-d3b2-429f-8a87-cba2049eda30&group=dd871b89-3484-42ff-91c5-6877a5e3df7f" target="_blank">
          Prueba la Alpha
        </Link>
      </section>
